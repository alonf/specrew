...
- **2026-06-08** — Cross-ref: [Proposal 172](172-hook-driven-session-bootstrap.md) (Hook-Driven Session Bootstrap) makes this orientation surface the payload of the SessionStart hook bootstrap directive (rendered by the agent, since hooks are non-interactive injectors per Feature 171). 172 wires 143's orientation + recovery (A/B/C) menu into the now-shipped F-171 hook dispatcher; it does not re-specify the orientation content here.
