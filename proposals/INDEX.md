...
| [131](131-coordinator-prompt-sdlc-ownership-clarification.md) | **HIGH PRIORITY** — Coordinator-Prompt SDLC Ownership Clarification (Agent-Driven With Human Approval) — small-fix slice fixing the F-047 Item 6 regression where embedding push/PR/review/merge as `HUMAN ACTION NEEDED` shifted perceived ownership; recommended Option B splits into `AGENT NEXT ACTION:` + `HUMAN ACTION NEEDED:` rows preserving backward compatibility while clarifying ownership; charter sync across coordinator + Scribe + mirror parity; integration test covers two-row HANDOFF shape; F-045 Codex baseline preserved; composes with 078 / 089 / 105 / 120 / 067; ship as part of F-048 bug-bash or standalone | phase-2 | 2-4 |
