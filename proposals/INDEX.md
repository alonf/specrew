...
| [120](120-handoff-block-validator-enforcement.md) | Handoff-Block Validator Enforcement + Non-Specrew-Session Bypass Detection — 4-pillar slice: (1) handoff-block presence check + shared `Test-SpecrewHandoffBlockPresent` helper, (2) trigger-bypass diagnosis augmentation, (3) wrong-location warning, (4) **state-advance-without-verdict cross-check (added 2026-05-26 from PlanningPoC iter-002 silent auto-advance breach caught by Picard, commit `a5866c1`)**; empirically motivated by 6 incidents (F-044 dashboards, Antigravity F-046 wrong-location, Squad+Copilot PlanningPoC handoff-drop, F-046 v0.27.2 4-gate autopilot, PlanningPoC post-compaction discipline drop, PlanningPoC state-layer auto-advance); composes with 030 / 067 / 075 / 078 / 105 | phase-2 | 4-7 |
