...
8. Treat `evaluation\report.md` as an on-demand generated artifact unless the contract explicitly requires it to be precommitted; review the writer path by invoking it and then inspect the rendered Markdown for the required sections.
...
- Early evaluation-harness slices
