...
5. If over capacity:
   - rank deferral candidates from the lowest-priority requirement slices first
...
The output is only good enough for planning when it makes deferral choices, requirement-priority impact, and phase-level variance explicit.
