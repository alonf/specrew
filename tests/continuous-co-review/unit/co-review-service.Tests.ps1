...
Describe 'Continuous co-review service detached launch failure evidence' {
    ...
    BeforeEach {
        # These are retained legacy-service characterizations. Select that authority explicitly;
        # campaign-mode production correctly suppresses this service before it can spawn.
