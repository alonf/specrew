...
$registry = @(
    ...
    @{ area = 'Beta3 workshop refusal convergence - derived actionable-refusal set, terminal escalation, and no hand-written controller escape'; path = 'tests/unit/workshop-refusal-contract.tests.ps1'; kind = 'script' }
