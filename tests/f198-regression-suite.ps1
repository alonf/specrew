...
$registry = @(
    ...
    @{ area = 'FR-056/SC-016 workshop question delivery - all host skill copies remain byte-identical to the canonical template'; path = 'tests/integration/code-rules-skill-multihost.tests.ps1'; kind = 'script' }
