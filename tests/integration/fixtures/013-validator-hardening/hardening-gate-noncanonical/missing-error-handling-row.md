...
| `fixture-follow-through` | `test-integrity` | `addressed` | `planning-time-analysis` | `pending-post-implementation` | Extra feature-specific concern rows may appear after the canonical five. | `false` | This row leaves a canonical concern missing on purpose. | — |
