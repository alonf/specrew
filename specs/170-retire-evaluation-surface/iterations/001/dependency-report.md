...
- Package/module dependencies changed: **0** (no manifest, package.json dependency, or module import was touched by the implementation delta).
- New-to-project dependencies: **0**.
- Vulnerability scan: not applicable — no dependency surface changed (file moves + reference edits only).
