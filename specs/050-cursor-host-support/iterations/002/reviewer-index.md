...
- Header: feature=050-cursor-host-support | iteration=002 | branch=050-cursor-host-support | commit_range=3aa22b360ef381c3cb8b2748f51251196e249221..d53f6a4e0b9f2b997e1499b017d5ab7f13b21f02
- Verdict: accepted
- Requirements: covered=FR-005, FR-006, FR-007 | not_covered=(none)
- Code Surface: files=10 | hotspots=0 | test_to_code=3:0
...
- Drift: 0/0 resolved
- Reviewer Index: specs\050-cursor-host-support\iterations\002\reviewer-index.md
- Implementation Briefing: (unavailable)
- Local Open Hints: specs\050-cursor-host-support\iterations\002\reviewer-index.md; specs\050-cursor-host-support\iterations\002\review-diagrams.md; specs\050-cursor-host-support\current-architecture.md
...
SPECREW_REVIEW schema=v1 iter=002 feature=050-cursor-host-support verdict=accepted tasks=3/3 reqs=3 files=10 new_deps=0 vuln=unscanned cov=focused_regression escalations=0 drift=0/0 index=specs\050-cursor-host-support\iterations\002\reviewer-index.md
