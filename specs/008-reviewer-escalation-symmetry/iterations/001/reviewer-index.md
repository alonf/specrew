...
- Header: feature=008-reviewer-escalation-symmetry | iteration=001 | branch=010-onboarding-resume-visibility | commit_range=unknown
- Verdict: accepted
- Requirements: covered=FR-006, FR-014, FR-008, FR-011, FR-001, FR-013, FR-007, FR-015 | not_covered=(none)
- Code Surface: files=0 | hotspots=0 | test_to_code=0:0
...
- Drift: 0/0 resolved
- Reviewer Index: specs\008-reviewer-escalation-symmetry\iterations\001\reviewer-index.md
- Implementation Briefing: (unavailable)
- Local Open Hints: specs\008-reviewer-escalation-symmetry\iterations\001\reviewer-index.md; specs\008-reviewer-escalation-symmetry\iterations\001\review-diagrams.md; specs\008-reviewer-escalation-symmetry\current-architecture.md
...
SPECREW_REVIEW schema=v1 iter=001 feature=008-reviewer-escalation-symmetry verdict=accepted tasks=7/7 reqs=7 files=0 new_deps=0 vuln=unscanned cov=focused_regression escalations=0 drift=0/0 index=specs\008-reviewer-escalation-symmetry\iterations\001\reviewer-index.md