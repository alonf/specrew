...
|---|---|---|---|
| Story points | 22-25 SP | ~36 SP (iter-001 18 + iter-002 6 + iter-003 4 + iter-004 3 + iter-005 5) | +11 SP via review-driven + manual-test-driven + UX-driven + release-prep cleanup |
| Iterations | 1 (Proposal 108 implicit) | 5 (architectural payoff + deep-review fix + manual-test fix + UX + release prep) | +4 (methodology shape — see retros) |
...
| F-044 (this) | [`spec.md`](./spec.md) | [`iterations/001/`](./iterations/001/) + [`iterations/002/`](./iterations/002/) + [`iterations/003/`](./iterations/003/) + [`iterations/004/`](./iterations/004/) + [`iterations/005/`](./iterations/005/) |
