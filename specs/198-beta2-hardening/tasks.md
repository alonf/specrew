...
to 9.75 SP. Current/valid run 13 independently closed the prior directions and found four bounded real defects:
retryable POSIX receipt parsing, truthful cross-host tool posture, schema-derived prompt budgets, and independent
two-stream drain observation. Their correction and direct/adjacent regressions add 1.25 SP and reprice T029 to
11.0 SP. One exact-head CI pass and one fresh independent review remain; only a new real defect may reopen code.
