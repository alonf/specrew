...
**Captured At**: 2026-07-16T11:24:36Z
**Render Mode**: full
...
Last enforcement timestamp: 07/16/2026 11:22:19
Total enforcement events: 19

SPECREW VELOCITY DASHBOARD
------------------------------------------------------------------------
Today: 2026-07-16 | Captured: 2026-07-16T11:24:36Z
Repo: specrew-beta2-hardening | Branch: 198-beta2-hardening
Rendering: monochrome-safe fallback
Summary: > F-198 0.40.0-beta2 Hardening Bundle (In Progress · phase iteration-closeout) | Velocity 5.17 SP/day (10 closed iterations, high)

ACTIVE WORK
Feature: > F-198 | 0.40.0-beta2 Hardening Bundle | status In Progress
Iteration: feature-198.iter-006 | phase ITERATION-CLOSEOUT | started 2026-07-16
In-flight: 43.3 SP planned | 31.3 SP delivered | 12 SP remaining
Multi-developer: 5 git authors | 0 machines | mode single

VELOCITY
Headline: 5.17 SP/day | confidence high
Sample basis: Based on 10 closed iteration(s), 175.8 SP across 34 calendar day(s) (avg 3.4 day(s)).
Trend: 16 / 9.3 / 6 / 26 / 17.5 / 19.5 / 19 / 28 / 10.5 / 24

RECENT SHIPPED
[x] F-198 · iter-006 #################...........  16.0 SP  3 iter 2026-07-16 0.40.0-beta2 Hardening Bundle
[x] F-198 · iter-002 ##########..................   9.3 SP  3 iter 2026-07-11 0.40.0-beta2 Hardening Bundle
[x] F-198 · iter-001 ######......................   6.0 SP  3 iter 2026-07-10 0.40.0-beta2 Hardening Bundle
...
feature-198.iter-006      16     16     0    1
...
Roadmap remaining: 566 SP | ETA: 110 calendar day(s) | confidence high

WARNINGS
WARN: Monochrome-safe fallback forced by --no-color / NO_COLOR.
WARN: Multi-developer activity detected: 5 unique git authors; 3 feature branches; 3 close-together shared-state writes
WARN: Multiple developers detected (5 unique git authors, 3 feature branches, 3 close-together shared-state writes). Consider enabling multi-session mode: `specrew config set session_mode multi`
