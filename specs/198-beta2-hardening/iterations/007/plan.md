...
| T053 | Shared production harness contract/catalog, remaining Claude hardening, and full malformed-output matrix | FR-060, FR-063, FR-064, SC-019, SC-021, NFR-007 | US2 | 1.5 | Implementer | scripts/internal/continuous-co-review/review-*-harness-port.ps1, scripts/internal/continuous-co-review/reviewer-host-catalog.ps1, tests/continuous-co-review/** | in-progress | Codex | — | — |
