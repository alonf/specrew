...
| T031 | Approval-tokenizer tightening, temporal ordering, and cursor-invariant guards (carried) | FR-042, NFR-007 | US1 | 0.5 | Implementer | scripts/internal/bootstrap/ConversationCaptureAccessor.ps1, tests/integration/** | in-progress | — | — | — |
