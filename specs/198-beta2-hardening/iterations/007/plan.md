...
| T060 | Live-smoke campaign and first four harness runs across three OSes, truthful support state, campaign cutover commit, and operator docs | FR-059, FR-060, FR-061, FR-064, FR-065, SC-018, SC-019, SC-020, SC-021, NFR-002 | US3 | 1.5 | Implementer | scripts/internal/continuous-co-review/review-authority-mode.json, scripts/internal/continuous-co-review/host-support-*.ps1, docs/**, specs/198-beta2-hardening/iterations/007/**, .specrew/review/** | in-progress | Codex | — | Codex/local macOS is clean. Cursor clean proof waits for free-credit reset. Antigravity run 03 drove the location-type hardening; run 04 proved that correction but exposed a stale host-neutral governance guard omitted from the 56-suite registry. DRIFT-198-I007-010 replaces the obsolete catalog-only exclusion with a closed host-bound seam and registers the guard as suite 57; all 57 suites and scoped governance pass. Commit/CI/preflight/verification, Copilot/Linux, support truth, and cutover remain; Claude/Windows remains T061. |
