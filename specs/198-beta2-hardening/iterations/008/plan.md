...
**Status**: reviewing
**Capacity**: 39.25/26 story_points
**Started**: 2026-07-18
**Completed**:
...
| T029 | Release `v0.40.0-beta2` after separately authorized release gate | FR-027, FR-039, FR-040, FR-055, FR-056, FR-061, FR-063, SC-008, SC-012, SC-013, SC-016, SC-020, SC-021, NFR-002 | Release | 8.5 | Implementer | Specrew.psd1, CHANGELOG.md, README.md, docs/**, skills/workshop mirrors, conformance-provider mirrors, scripts/init/**, scripts/specrew-init.ps1, scripts/internal/file-classification.ps1, scripts/internal/continuous-co-review/**, scripts/internal/validate-versions.ps1, tests/**, .github/workflows/** | blocked | Implementer | 8.5 | run-08 follow-ons and 75-suite local aggregate pass; hosted verification, fresh independent review, maintainer clean-project retest, and merge authority remain |
...
| Planned Effort | 39.25 | Core finish line plus T068–T071, seven observed T066 correction classes, and the T029 live-console/review-runtime/Copilot workshop corrections |
| Overcommit Threshold | 1.0 | No overcommit allowed |
| Capacity Status | overcommitted | T071 and the T029 observed corrections are explicit; the iteration is 13.25 SP over cap |
...
- Selected total: 39.25 SP. T071 plus the T029 live-console/review-runtime/Copilot workshop corrections create a disclosed 13.25 SP overcommit; no optional scope may be added silently.

Iterations 001 and 002 expanded about 16–17% from plan to actual. The T071 plus T029 correction slice totals
13.25 SP. Applying 17% to that open-work slice forecasts 41.50 SP total, 15.50 SP above capacity. The nominal and
...
| Authorized prerelease publication and live-console/review-runtime/Copilot workshop corrections | 8.5 | T029 |
| Published-beta consumer dogfood | 1.0 | T067 |
| **Total** | **39.25** | Includes the disclosed 13.25 SP evidence-driven overcommit |
