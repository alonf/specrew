...
| T029 | Release `v0.40.0-beta2` after separately authorized release gate | FR-027, FR-039, FR-040, FR-055, FR-056, FR-061, FR-063, SC-008, SC-012, SC-013, SC-016, SC-020, SC-021, NFR-002 | Release | 9.5 | Implementer | Specrew.psd1, CHANGELOG.md, README.md, docs/**, skills/workshop mirrors, conformance-provider mirrors, bootstrap workshop-state accessor, scripts/init/**, scripts/specrew-init.ps1, scripts/internal/file-classification.ps1, scripts/internal/continuous-co-review/**, scripts/internal/validate-versions.ps1, tests/**, .github/workflows/** | blocked | Implementer | 9.5 | strict artifact-derived workshop active/complete proof and all 76 registered suites are green; hosted verification, fresh independent review, fresh-project Copilot completion retest, and merge authority remain |
...
| FR-055, FR-056 | Real injected-environment-context reproduction, shared-baseline cross-session attribution, live turn-start fingerprints, stale-handover read-only session, consecutive turns, same-path re-edit, concurrent sessions, stale-binding class, and leading approval-plus-instructions preservation; strict feature/exact-iteration workshop artifacts prove active and complete independently of host prose/tools, with malformed/incomplete/stale/cross-scope and lifecycle-boundary denial fixtures |
