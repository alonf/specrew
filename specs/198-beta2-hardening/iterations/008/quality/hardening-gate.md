...
| `condition-h-release-authority` | `met` | Clean T066 run 11 and the human review-signoff verdict satisfy the review prerequisite; T029 still requires its separate release authorization. | Do not tag or publish under review-signoff approval. |
