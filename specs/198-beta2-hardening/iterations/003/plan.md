...
| T015 | Confinement contract + teaching; auto per-review verification REMOVED (option-1, DRIFT-198-I003-003) — bounded helper opt-in only, T018 owns verification; monitored confinement, integrity mandatory | FR-010, FR-013 | US2 | 0.5 | Implementer | scripts/internal/continuous-co-review/**, .specrew/review/process/** | done | — | 2.5 | — |
| T016 | Containment MONITOR (T100 registry) — REOPENED + FR-011/SC-003 AMENDED (maintainer review 2026-07-12): STRONG cwd/exe-under-origin = hard containment-violated; argv = best-effort diagnostic warning (never discards a valid review); sampler health recorded; T013 structural guarantee | FR-011[amended], SC-003 | US2 | 1.0 | Implementer | scripts/internal/continuous-co-review/**, tests/** | done | — | 4.0 | — |
| T017 | ONE machinery list — function-based single source (Get-ContinuousCoReviewMachineryPaths) consumed by BOTH the digest strip AND the worktree strip, by construction; fails loudly on resolver load/exec failure; machinery-only ≠ identity change; workflows/source reviewable + digest-significant | FR-012 | US2 | 1.5 | Implementer | scripts/internal/continuous-co-review/**, tests/** | done | — | 2.0 | — |
| T018 | Universal recorded-run evidence runner (AMENDED 2026-07-13: language/framework-neutral — direct command-execution facts + OPTIONAL schema-valid SpecrewTestResult; no framework parsers; caller counts forbidden; fail-loud; evidence-only) | FR-014, FR-015[amended] | US3 | 1.0 | Implementer | scripts/internal/continuous-co-review/**, specs/198-beta2-hardening/contracts/**, extensions/specrew-speckit/refocus/**, tests/** | done | — | 1.0 | — |
| T019 | Checkpoint baselines + frozen digest threading + in-flight dedup | FR-016, FR-017 | US3 | 1.5 | Implementer | scripts/internal/continuous-co-review/continuous-co-review-navigator.ps1, tests/** | deferred | — | — | — |
...
| T030 | Machinery-turn exclusion from verdict evidence | FR-041 | US1 | 0.75 | Implementer | scripts/internal/bootstrap/ConversationCaptureAccessor.ps1, tests/integration/** | deferred | — | — | — |
| T031 | Approval-tokenizer tightening + temporal-ordering + cursor-invariant guards | FR-042 | US1 | 0.5 | Implementer | scripts/internal/bootstrap/ConversationCaptureAccessor.ps1, tests/integration/** | deferred | — | — | — |
| T032 | Fabrication-sequence regression fixtures (re-enable acceptance surface) | FR-043 | US1 | 0.5 | Implementer | tests/integration/verdict-capture-blocks.tests.ps1 | deferred | — | — | — |
| T033 | Ledger correction door (append-only invalidation records) | FR-044 | US1 | 1.0 | Implementer | extensions/specrew-speckit/scripts/shared-governance.ps1, .specify/**, tests/** | deferred | — | — | — |
| T034b | Devin cherry-pick + regression set + live-round compat (AT LANDING) | FR-012, FR-017 | US2 | 0.5 | Implementer | scripts/internal/continuous-co-review/**, tests/continuous-co-review/** | deferred | — | — | — |
