...
- Header: feature=001-specrew-product | iteration=010 | branch=002-fix-team-help | commit_range=e946390c0fbb404f39e29a20b9cd401730a688f1..517a9c2d7b1e291d5382cf3951c4badbd0a9f78d
- Verdict: accepted
- Requirements: covered=FR-042 | not_covered=(none)
- Code Surface: files=16 | hotspots=0 | test_to_code=6:1
...
- Drift: 0/0 resolved
- Reviewer Index: specs\001-specrew-product\iterations\010\reviewer-index.md
- Implementation Briefing: (unavailable)
- Local Open Hints: specs\001-specrew-product\iterations\010\reviewer-index.md; specs\001-specrew-product\iterations\010\review-diagrams.md; specs\001-specrew-product\current-architecture.md
...
SPECREW_REVIEW schema=v1 iter=010 feature=001-specrew-product verdict=accepted tasks=4/4 reqs=4 files=16 new_deps=0 vuln=unscanned cov=not_executed escalations=0 drift=0/0 index=specs\001-specrew-product\iterations\010\reviewer-index.md