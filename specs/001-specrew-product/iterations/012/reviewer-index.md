...
- Header: feature=001-specrew-product | iteration=012 | branch=004-post-planning-review | commit_range=0440f16f475a9ff4d06b0cb372111aa62069588e..0440f16f475a9ff4d06b0cb372111aa62069588e
- Verdict: accepted
- Requirements: covered=FR-024 | not_covered=(none)
- Code Surface: files=6 | hotspots=0 | test_to_code=1:2
...
- Drift: 0/0 resolved
- Reviewer Index: specs\001-specrew-product\iterations\012\reviewer-index.md
- Implementation Briefing: (unavailable)
- Local Open Hints: specs\001-specrew-product\iterations\012\reviewer-index.md; specs\001-specrew-product\iterations\012\review-diagrams.md; specs\001-specrew-product\current-architecture.md
...
SPECREW_REVIEW schema=v1 iter=012 feature=001-specrew-product verdict=accepted tasks=3/3 reqs=3 files=6 new_deps=0 vuln=unscanned cov=not_executed escalations=0 drift=0/0 index=specs\001-specrew-product\iterations\012\reviewer-index.md