...
- **TG-001**: Each user story MUST map to one or more functional requirements.
  ...
  - US-2 (Iteration) → FR-005, FR-006, FR-007, FR-009, FR-010, FR-017, FR-018, FR-019, FR-024, FR-026, FR-027, FR-028, FR-030, FR-031, FR-032, FR-033, FR-034
...
- **TG-002**: Each requirement MUST identify expected owner role(s).
  ...
  - FR-005–FR-007, FR-009–FR-010, FR-017–FR-018, FR-026–FR-027, FR-032–FR-034: Iteration engine
  ...
  - FR-027: Iteration engine + decisions ledger workflow
...
| 5 | Squad | team shaping | After spec/clarify, Squad proposes missing specialists, preserves user-added members, and presents the final team |
...
| 11 | Squad | implementation briefing | Squad presents a code-review-ready summary of behavior, requirements, flows, dependencies, and testing confidence |
| 12 | Squad | Retrospective ceremony | Retro Facilitator generates `retro.md` artifact |
| 13 | CLI | `specrew start` | Repeat the lifecycle for the next feature or fix, with Squad gathering intake when needed |
