...
| ---- | ----- | ----------- | ----- | ------ | ----- | ---------------- | ------ | ----- | ------ | ------- |
| T001 | Confirm the approved Iteration 001 boundary and two-iteration split | FR-001, FR-006, FR-007 | Boundary | 0.25 | Spec steward | `specs/014-handoff-format-scoping/plan.md`, `specs/014-handoff-format-scoping/tasks.md` | done | Spec Steward | Confirmed the approved boundary in `plan.md`; no Iteration 002 scope was opened | pass |
| T002 | Confirm the deferred proof-work boundary and preserved regression lane | FR-006, FR-007 | Boundary | 0.25 | Iteration facilitator | `specs/014-handoff-format-scoping/quickstart.md` | done | Planner | Reconciled `quickstart.md` so Iteration 001 covers only the known-traps applicability wording while proof/graduation stays deferred | pass |
| T003 | Update response-type selector criteria and first-acknowledgement guidance | FR-001, FR-002 | US1 | 0.75 | Governance prompt stewards | `extensions/specrew-speckit/prompts/coordinator-decision-guidance.md` | done | Planner | Added response-type selection, first-acknowledgement guidance, and stop-vs-progress examples | pass |
| T004 | Update coordinator response instructions and worked examples | FR-001, FR-002 | US1 | 0.75 | Governance prompt stewards | `extensions/specrew-speckit/prompts/coordinator-response.md` | done | Planner | Split final-stop vs in-flight-progress guidance and updated worked examples | pass |
| T005 | Update dual response-type examples while preserving the stop format | FR-003 | US1 | 0.50 | Handoff-template stewards | `specs/001-specrew-product/contracts/coordinator-handoff-template.md` | done | Planner | Added selector guidance and in-flight progress patterns while preserving the existing stop format | pass |
| T006 | Add fixed placeholder-phrase matching and empty-user-action warning logic | FR-004 | US2 | 1.00 | Validator maintainers | `extensions/specrew-speckit/validators/handoff-governance-validator.ps1` | done | Implementer | Added the fixed placeholder phrase list and `soft-warning.empty-user-action-section` detection | pass |
| T007 | Add transitional-stop-claim warning logic and preserve additive soft-warning behavior | FR-005, FR-006 | US2 | 1.00 | Validator maintainers | `extensions/specrew-speckit/validators/handoff-governance-validator.ps1` | done | Implementer | Added `soft-warning.transitional-stop-claim` with additive, advisory behavior preserved | pass |
| T008 | Manually exercise the new warning paths against the approved scenarios | FR-004, FR-005, FR-006 | US2 | 0.50 | Validator maintainers | `specs/014-handoff-format-scoping/contracts/coordinator-handoff-scoping.md`, `extensions/specrew-speckit/validators/handoff-governance-validator.ps1` | done | Reviewer | Ran four bounded validator scenarios and recorded the observed outputs in the contract and state artifacts | pass |
| T009 | Update selector and mixed-case review criteria | FR-002 | US3 | 0.50 | Governance prompt stewards | `extensions/specrew-speckit/checklists/coordinator-handoff-governance.md` | done | Planner | Added selector, mixed-case, in-flight-shape, and warning review criteria to the checklist | pass |
| T010 | Update coordinator runtime guidance for stop-vs-progress scoping | FR-002 | US3 | 0.50 | Agent-guidance stewards | `.github/agents/squad.agent.md` | done | Planner | Updated runtime Squad guidance to distinguish final stops from in-flight progress updates | pass |
| T011 | Update generated Squad template guidance for stop-vs-progress scoping | FR-002 | US3 | 0.50 | Agent-guidance stewards | `.squad/templates/squad.agent.md` | done | Planner | Updated generated Squad template guidance to match the runtime selector wording | pass |
| T012 | Extend the `human-handoff-id-context` row to cover both governed response types | FR-007 | US3 | 0.50 | Governance corpus stewards | `.specrew/quality/known-traps.md` | done | Planner | Extended the existing `human-handoff-id-context` row to both response types without adding the deferred graduation | pass |
| T013 | Reconcile cross-artifact wording against the approved selector contract | FR-002, FR-003, FR-007 | US3 | 0.25 | Iteration facilitator | `specs/014-handoff-format-scoping/contracts/coordinator-handoff-scoping.md`, `extensions/specrew-speckit/prompts/`, `.github/agents/squad.agent.md`, `.squad/templates/squad.agent.md` | done | Planner | Reconciled the contract wording, examples, and manual evidence with the updated selector | pass |
| T014 | Run preserved handoff-governance regression scripts for additive-warning compatibility | FR-006 | Validation | 0.50 | Test maintainers | `tests/integration/handoff-governance-*.ps1` | done | Reviewer | Ran the five preserved handoff-governance regression scripts; all passed | pass |
| T015 | Run repository governance validation for bounded Iteration 001 compliance | FR-006 | Validation | 0.25 | Validator maintainers | `extensions/specrew-speckit/scripts/validate-governance.ps1` | done | Reviewer | Ran `validate-governance.ps1 -ProjectPath .`; all iteration checks passed, including `specs/014-handoff-format-scoping/iterations/001` | pass |
