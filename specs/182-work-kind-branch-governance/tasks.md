...
- [ ] T013 [i1] [US1] [Owner: Implementer] [Capacity: 1 SP] Registration/ship: add the new deployable files (`work-kinds.yml`, the 2 schemas, the 3 capture templates, the 2 lifecycle templates, the adapter + generic-fallback scripts, the methodology doc) to `Specrew.psd1` FileList + bump `extension.yml` version + mirror to `.specify/` (the F-176/177 release discipline) (Trace: FR-013, SC-007).
...
- **Every FR has ≥1 task**: FR-001 (T001,T002,T005,T014); FR-002 (T004); FR-003 (T003,T004,T014);
  ...
  FR-009 (T002,T008,T014); FR-010 (T011); FR-011 (T018,T020); FR-012 (T017,T020); FR-013 (T013,T019);
...
- **Every SC has ≥1 task**: SC-001 (T001,T005,T014); SC-002 (T004); SC-003 (T006); SC-004 (T005);
  SC-005 (T016,T020); SC-006 (T017,T020); SC-007 (T013,T019); SC-008 (T011,T022); SC-009 (T018,T020);
