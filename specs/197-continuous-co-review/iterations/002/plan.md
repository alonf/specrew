...
| ---- | ----- | ----------- | ----- | ------ | ----- | ---------------- | ------ | ----- | ------ | ------- |
| T051 | Merge/rebase latest remote `main` before runtime repair work and re-run protected-surface guard. | FR-023, IMPL-011, TG-013, SC-006, SC-011 | Reviewer-definition repair | 1.00 | Iteration Facilitator | `.git/**`; `specs/197-continuous-co-review/iterations/002/**` | planned |  |  |  |
| T052 | Add canonical reviewer instruction source and tests for Proposal 145 rubric, lens validation, policies, and round protocol. | FR-017, SEC-007, IMPL-008, SC-013, TG-013 | Reviewer-definition repair | 1.00 | Spec Steward | `scripts/internal/continuous-co-review/code-review-agent.md`; `tests/continuous-co-review/**` | planned |  |  |  |
