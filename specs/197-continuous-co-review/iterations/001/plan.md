...
| T036 | Add Cursor adapter fixture tests in `tests/continuous-co-review/unit/reviewer-host-adapter-... | FR-012 | US3 | 0.25 | Reviewer | tests/continuous-co-review/unit/reviewer-host-adapter-cursor-agent-prompt.Tests.ps1 | planned | — | — | — |
| T037 | Add Antigravity adapter fixture tests in `tests/continuous-co-review/unit/reviewer-host-ada... | FR-012 | US3 | 0.25 | Reviewer | tests/continuous-co-review/unit/reviewer-host-adapter-antigravity-prompt.Tests.ps1 | planned | — | — | — |
...
| T042 | Implement all five phase-1 real headless adapters for Claude, Codex, Copilot, Cursor,... | FR-012 | US3 | 0.75 | Implementer | scripts/internal/continuous-co-review/reviewer-host-adapter-*.ps1 | planned | — | — | — |
...
| T049 | Add maintainer-run manual real-host validation runbook with commands, expected results, and result... | SC-012 | Shared | 0.25 | Spec Steward | specs/197-continuous-co-review/iterations/001/manual-validation.md | planned | — | — | — |
| T050 | Add canonical planted-design-violation fixture and expected blocking-finding notes | SC-012 | Shared | 0.25 | Reviewer | specs/197-continuous-co-review/iterations/001/planted-design-violation.diff | planned | — | — | — |
...
- Feature-local capacity status: 19.50/20 SP remains within the configured Iteration 001 cap after restoring T035, T036, T037, all five T042 adapters, and SC-012 manual-validation enablers.
