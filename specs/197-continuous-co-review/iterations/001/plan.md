...
| T035 | Add Copilot adapter fixture tests in `tests/continuous-co-review/unit/reviewer-host-adapter-... | FR-012 | US3 | 0.25 | Reviewer | tests/continuous-co-review/unit/reviewer-host-adapter-copilot-prompt.Tests.ps1 | planned | — | — | — |
| T036 | Add Cursor adapter fixture tests in `tests/continuous-co-review/unit/reviewer-host-adapter-c... | FR-012 | US3 | 0.25 | Reviewer | tests/continuous-co-review/unit/reviewer-host-adapter-cursor-agent-prompt.Tests.ps1 | planned | — | — | — |
| T037 | Add Antigravity adapter fixture tests in `tests/continuous-co-review/unit/reviewer-host-adap... | FR-012 | US3 | 0.25 | Reviewer | tests/continuous-co-review/unit/reviewer-host-adapter-antigravity-prompt.Tests.ps1 | planned | — | — | — |
...
| T042 | Implement real headless adapter files `scripts/internal/continuous-co-review/reviewer-host-a... | FR-012 | US3 | 0.50 | Implementer | scripts/internal/continuous-co-review/reviewer-host-adapter-claude-prompt.ps1 | planned | — | — | — |
...
- Workstream separability: Approved task decomposition identifies 27 parallel-safe tasks after the dependency spine is satisfied; baseline roles remain sufficient for Iteration 001.
...
| Implementation | 18.75 | Approved task spine, pending explicit 0.75 SP overcommit decision before implementation |
...
- Task decomposition: 48 tasks in specs/197-continuous-co-review/tasks.md, all mapped to at least one FR/SC and implementation-rules.yml.
...
- Feature-local capacity warning remains explicit: 18.75/18 SP exceeds the approved Iteration 001 spine budget by 0.75 SP and requires human acceptance or deferral before implementation.
