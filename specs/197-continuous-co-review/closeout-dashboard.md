...
Iteration: feature-197.iter-008 | phase ABANDONED | started 2026-06-27
...
WARN: Multi-developer activity detected: 5 unique git authors; 3 close-together shared-state writes
WARN: Multiple developers detected (5 unique git authors, 3 close-together shared-state writes). Consider enabling multi-session mode: `specrew config set session_mode multi`
