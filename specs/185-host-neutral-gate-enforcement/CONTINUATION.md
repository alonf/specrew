...
- **Then:** cross-host dogfood (SC-001/006/007/009/010 real-host) + the Proposal-145 review (the FR-011 detection lands with its own Proposal-145 adversarial verification pass this session).
