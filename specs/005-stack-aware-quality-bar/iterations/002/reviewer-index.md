...
- Header: feature=005-stack-aware-quality-bar | iteration=002 | branch=008-quality-profile-foundation | commit_range=c87f204c39463eb765a819a7cc56b9416dd925b7..fe61d4aacb5d8433b9d020f286e3d1388c6b2edd
- Verdict: accepted
- Requirements: covered=FR-027, FR-028, FR-029, FR-030, FR-011, FR-012 | not_covered=(none)
- Code Surface: files=12 | hotspots=1 | test_to_code=0:1
...
SPECREW_REVIEW schema=v1 iter=002 feature=005-stack-aware-quality-bar verdict=accepted tasks=7/7 reqs=7 files=12 new_deps=0 vuln=unscanned cov=focused_regression escalations=1 drift=0/0 index=specs\005-stack-aware-quality-bar\iterations\002\reviewer-index.md
