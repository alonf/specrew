...
| --- | --- | --- | --- | ---: | --- | --- | --- | --- |
| T001 | Discovery spike: B3-on-PreInvocation split-guard proof | FR-003, FR-010, SC-009, TG-004, TG-005 | US2 | 3 | Planner, Reviewer | `scripts/internal/bootstrap/**`; `scripts/internal/specrew-hook-dispatcher.ps1`; `extensions/specrew-speckit/scripts/**`; `hosts/antigravity/**`; `specs/184-full-antigravity-refocus/**` | planned | Evidence rows for `fresh-boundary-cursor`, `exactly-once-b3`, and `bounded-host-model` all PASS or implementation stops. |
| T002 | Antigravity session identity and per-session refocus state/anchor | FR-001, FR-002, FR-005, SC-001, SC-002 | US1, US4 | 4 | Implementer | `scripts/internal/bootstrap/**`; `scripts/internal/specrew-hook-dispatcher.ps1`; `extensions/specrew-speckit/scripts/**`; `tests/bootstrap/**`; `tests/integration/refocus-dispatcher.tests.ps1` | planned | Automated tests prove real `conversationId` keys and no global `unknown`; manual `agy --conversation` proves exit/re-entry anchor persistence. |
