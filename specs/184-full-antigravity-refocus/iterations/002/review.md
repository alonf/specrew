...
| T006 | FR-017, SC-016, SC-017, SC-018, TG-005 | pass | Real-host (machine-local, TG-005): FR-011 + governed workshop validated on strong models (Opus/Claude), cross-host resume, integrity held. SC-017 weak-model (Flash) boundary-discipline FAIL = the FR-017-required honest caveat (evidence, NOT failure). GEMINI.md priority docs-corroborated only. See real-host-evidence.md. |
