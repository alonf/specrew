...
| T006 | Run real-host Antigravity Opus 4.6 and Gemini Flash dogfood evidence | FR-017, SC-016, SC-017, SC-018, TG-005 | US7 | 3 | Reviewer, Human | `specs/184-full-antigravity-refocus/iterations/002/**` | done | claude + human | 3 | real-host evidence recorded (machine-local); weak-model caveat preserved (FR-017) |
