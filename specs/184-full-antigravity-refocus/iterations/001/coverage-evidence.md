...
All in-scope automated validation commands passed after the T008 repair and the
review-sendback abstraction-leak repair. Manual real-host Antigravity evidence
is machine-local and recorded separately.
...
| SHA-256 comparison for provider/deployer/dispatcher source/extension/`.specify` copies | PASS via `ProviderMirrorParity.Tests.ps1`. |
...
| FR-003 | `refocus-dispatcher.tests.ps1`, `Regression.Tests.ps1`, `host-registry.tests.ps1`, real-host B3 journal. |
| FR-004 | `ClassificationEngine.Tests.ps1`, `SessionBootstrapManager.Tests.ps1`, real-host bootstrap journal. |
| FR-005 | `refocus-deploy.tests.ps1`, `specrew-hooks-command.tests.ps1`, `HostDeliveryPolicy.Tests.ps1`, real-host PreInvocation/Stop logs and handover. |
...
| FR-010 | T001 discovery, dispatcher tests, `host-coupling-firewall.tests.ps1`, manifest runtime-policy tests, and real-host no-refactor proof. |
