...
**Captured At**: 2026-06-17T12:19:59Z
**Render Mode**: full
...
Last enforcement timestamp: 06/17/2026 12:18:08
Total enforcement events: 8

SPECREW VELOCITY DASHBOARD
------------------------------------------------------------------------
Today: 2026-06-17 | Captured: 2026-06-17T12:19:59Z
Repo: 183-stability-quality-bundle | Branch: 184-full-antigravity-refocus
Rendering: monochrome-safe fallback
Summary: > F-184 Full Antigravity Refocus (Implementation Complete · phase iteration-closeout) | Velocity 12.72 SP/day (10 closed iterations, high)

ACTIVE WORK
Feature: > F-184 | Full Antigravity Refocus | status Implementation Complete
Iteration: feature-184.iter-001 | phase ITERATION-CLOSEOUT | started 2026-06-17
In-flight: 26 SP planned | 26 SP delivered | 0 SP remaining
Multi-developer: 4 git authors | 1 machines | mode single

VELOCITY
Headline: 12.72 SP/day | confidence high
Sample basis: Based on 10 closed iteration(s), 203.5 SP across 16 calendar day(s) (avg 1.6 day(s)).
Trend: 26 / 28 / 16 / 32 / 22 / 17 / 14 / 17 / 15.5 / 16

RECENT SHIPPED
[x] F-184 · iter-001 #######################.....  26.0 SP  1 iter 2026-06-17 Full Antigravity Refocus
...
Roadmap remaining: 566 SP | ETA: 45 calendar day(s) | confidence high

WARNINGS
WARN: Monochrome-safe fallback forced by --no-color / NO_COLOR.
WARN: Multi-developer activity detected: 4 unique git authors; 9 feature branches; 4 close-together shared-state writes
WARN: Multiple developers detected (4 unique git authors, 9 feature branches, 4 close-together shared-state writes). Consider enabling multi-session mode: `specrew config set session_mode multi`
