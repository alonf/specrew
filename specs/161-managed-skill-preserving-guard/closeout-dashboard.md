...
**Captured At**: 2026-06-06T13:50:47Z
**Render Mode**: full
...
Last enforcement timestamp: 06/06/2026 13:50:28
Total enforcement events: 11

SPECREW VELOCITY DASHBOARD
------------------------------------------------------------------------
Today: 2026-06-06 | Captured: 2026-06-06T13:50:47Z
Repo: Specrew-managed-skill-guard | Branch: 161-managed-skill-preserving-guard
Rendering: monochrome-safe fallback
Summary: > F-161 Managed-Skill "Stuck Preserving" Guard (Implementation Complete) | Velocity 12.25 SP/day (10 closed iterations, high)
...
WARN: Multi-developer activity detected: 3 unique git authors; 3 close-together shared-state writes; 27 feature branches
WARN: Multiple developers detected (3 unique git authors, 3 close-together shared-state writes, 27 feature branches). Consider enabling multi-session mode: `specrew config set session_mode multi`
WARN: Feature '161-managed-skill-preserving-guard' has no active iteration artifact; showing feature-level context only.
