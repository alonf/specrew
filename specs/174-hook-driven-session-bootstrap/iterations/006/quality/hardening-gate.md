...
- Per-host injection is EMPIRICAL (FR-024): the parity set is the deployed floor's output. iter-6 proves
  Claude end-to-end; codex/copilot/cursor injection re-tests are ENUMERATED as explicit follow-on (T039),
  not done this iteration (20 SP cap).
