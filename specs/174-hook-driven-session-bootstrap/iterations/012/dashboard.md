...
**Captured At**: 2026-06-15T02:06:25Z
**Render Mode**: full
...
Last enforcement timestamp: 06/15/2026 02:04:57
Total enforcement events: 1

SPECREW VELOCITY DASHBOARD
------------------------------------------------------------------------
Today: 2026-06-15 | Captured: 2026-06-15T02:06:25Z
Repo: Specrew-session-bootstrap | Branch: 174-hook-driven-session-bootstrap
Rendering: monochrome-safe fallback
Summary: > F-174 Hook-Driven Session Bootstrap (Implementation Complete · phase iteration-closeout) | Velocity 11.03 SP/day (10 closed iterations, high)

ACTIVE WORK
Feature: > F-174 | Hook-Driven Session Bootstrap | status Implementation Complete
Iteration: feature-174.iter-012 | phase ITERATION-CLOSEOUT | started 2026-06-14
In-flight: 202 SP planned | 202 SP delivered | 0 SP remaining
Multi-developer: 4 git authors | 1 machines | mode single

VELOCITY
Headline: 11.03 SP/day | confidence high
Sample basis: Based on 10 closed iteration(s), 176.5 SP across 16 calendar day(s) (avg 1.6 day(s)).
Trend: 16 / 32 / 22 / 17 / 14 / 17 / 15.5 / 16 / 13.5 / 13.5
...
[x] F-182 · iter-002 ###############.............  17.0 SP  4 iter 2026-06-12 Work Kind and Branch Governan...
...
feature-174.iter-010      22     22     0    3
...
Roadmap remaining: 566 SP | ETA: 52 calendar day(s) | confidence high

WARNINGS
WARN: Monochrome-safe fallback forced by --no-color / NO_COLOR.
WARN: Multi-developer activity detected: 4 unique git authors; 7 feature branches; 4 close-together shared-state writes
WARN: Multiple developers detected (4 unique git authors, 7 feature branches, 4 close-together shared-state writes). Consider enabling multi-session mode: `specrew config set session_mode multi`
