...
**Schema**: v1
**Current Phase**: implement (T048 + T049 done; T050 in progress — handover-provider mirror skew fixed + the anchorless-workshop handover fix IMPLEMENTED + proven; live cross-host re-test DONE 2026-06-11 → iteration CLOSED, hollow-handover finding carried to iteration 009)
