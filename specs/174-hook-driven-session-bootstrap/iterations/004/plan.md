...
| T025 | Stop-event handover provider: fire on Stop, material-change gate, write the rolling handover via HandoverStore (not SessionEnd write-logic; design-record phrase corrected in T041) | FR-009 | US-3 | 2 | Implementer | scripts/internal/specrew-handover-provider.ps1 | done | claude | 2 | — |
