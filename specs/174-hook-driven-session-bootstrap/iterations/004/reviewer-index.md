...
- Header: feature=174-hook-driven-session-bootstrap | iteration=004 | branch=174-hook-driven-session-bootstrap | commit_range=4cd5183263778eb1dd5245de586e0ec2702da38f..f4080821dee7e8df7890f096b2fc8ba0b01f4161
- Verdict: needs-rework
- Requirements: covered=FR-009, FR-005, FR-008 | not_covered=(none)
- Code Surface: files=21 | hotspots=0 | test_to_code=6:6
...
- Drift: 0/0 resolved
- Reviewer Index: specs\174-hook-driven-session-bootstrap\iterations\004\reviewer-index.md
- Implementation Briefing: (unavailable)
- Local Open Hints: specs\174-hook-driven-session-bootstrap\iterations\004\reviewer-index.md; specs\174-hook-driven-session-bootstrap\iterations\004\review-diagrams.md; specs\174-hook-driven-session-bootstrap\current-architecture.md
...
SPECREW_REVIEW schema=v1 iter=004 feature=174-hook-driven-session-bootstrap verdict=needs-rework tasks=0/6 reqs=6 files=21 new_deps=0 vuln=unscanned cov=focused_regression escalations=0 drift=0/0 index=specs\174-hook-driven-session-bootstrap\iterations\004\reviewer-index.md