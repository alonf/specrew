...
**Captured At**: 2026-06-08T23:12:30Z
**Render Mode**: full
...
Last enforcement timestamp: 06/08/2026 23:12:23
Total enforcement events: 17

SPECREW VELOCITY DASHBOARD
------------------------------------------------------------------------
Today: 2026-06-09 | Captured: 2026-06-08T23:12:30Z
Repo: Specrew-session-bootstrap | Branch: 174-hook-driven-session-bootstrap
Rendering: monochrome-safe fallback
Summary: > F-174 Hook-Driven Session Bootstrap (Implementation Complete) | Velocity 8.86 SP/day (10 closed iterations, high)

ACTIVE WORK
Feature: > F-174 | Hook-Driven Session Bootstrap | status Implementation Complete
No active iteration is recorded for the current feature.
Multi-developer: 3 git authors | 1 machines | mode single

VELOCITY
Headline: 8.86 SP/day | confidence high
Sample basis: Based on 10 closed iteration(s), 97.5 SP across 11 calendar day(s) (avg 1.1 day(s)).
Trend: 18 / 11 / 12 / 12.5 / 3 / 18.5 / 2 / 6.5 / 8 / 6

RECENT SHIPPED
[x] F-174 · iter-003 ###########################.  18.0 SP  3 iter 2026-06-09 Hook-Driven Session Bootstrap
[x] F-174 · iter-002 #################...........  11.0 SP  3 iter 2026-06-08 Hook-Driven Session Bootstrap
[x] F-174 · iter-001 ##################..........  12.0 SP  3 iter 2026-06-08 Hook-Driven Session Bootstrap
...
feature-174.iter-003      18     18     0    2
feature-174.iter-002      11     11     0    1
feature-174.iter-001      12     12     0    1

FULL HISTORY
feature-174.iter-003    18 SP ################
feature-174.iter-002    11 SP ##########......
feature-174.iter-001    12 SP ##########......
...
Roadmap remaining: 566 SP | ETA: 64 calendar day(s) | confidence high

WARNINGS
WARN: Monochrome-safe fallback forced by --no-color / NO_COLOR.
WARN: Multi-developer activity detected: 3 unique git authors; 33 feature branches; 3 close-together shared-state writes
WARN: Multiple developers detected (3 unique git authors, 33 feature branches, 3 close-together shared-state writes). Consider enabling multi-session mode: `specrew config set session_mode multi`
WARN: Feature '174-hook-driven-session-bootstrap' has no active iteration artifact; showing feature-level context only.
