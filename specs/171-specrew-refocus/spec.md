...
- **Provider registry row**: `{id, kind: inject|gate, events[], order, budget_share, command}` — the extension seat for future mechanisms (130-P4 handover as `inject`; F-165 file-link gate as `gate`) without host-config changes.
