...
- **Provider registry row**: `{id, events[], order, budget_share, command}` — the extension seat for future mechanisms (e.g., 130-P4 handover) without host-config changes.
