...
| T005 | Tests: no `specs//` in generated paths; per-host wording; clean harness exit | SC-007, SC-010 | US4 | 2 | Implementer | tests/unit/**, tests/integration/** | in-progress | claude | — | — |
