...
| T007 | Docs + human-experience dogfood (run the interactive intake for real — demonstrate dial-adaptation + surfaced decisions, the human-experience test Iteration 5's retro flagged as missing) + implemented/enforced/observable/documented gap ledger (TG-006) | TG-006 | US0 | 1 | Planner | specs/141-design-gate-runtime-hardening/** | done | claude | — | pass |
