...
```mermaid
flowchart TD
  scripts_internal_lens_applicability["scripts/internal/lens-applicability"]
```
...
- specs\141-design-gate-runtime-hardening\iterations\005\review-diagrams.md
