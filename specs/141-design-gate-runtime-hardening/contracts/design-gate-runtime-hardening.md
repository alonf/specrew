...
- `Invoke-SpecrewDesignAnalysisPrePlanGate` — callable pre-plan validator; throws `[design-analysis-pre-plan-gate]` when the active substantive artifact/decision is invalid (FR-002/FR-003/FR-021). Coordinator-prompt enforcement is generated by `scripts/specrew-start.ps1`.
