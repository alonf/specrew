...
- [x] T002 [US1] [Owner: Implementer, Reviewer] [Capacity: 2 SP] Rewrite `tests/bootstrap/DirectiveDeliveryCap.Tests.ps1` to measure a synthetic shipped SessionStart composite rather than ambient developer-machine refocus state (Trace: FR-004, SC-004).
...
- [x] T010 [US3] [Owner: Spec Steward, Reviewer] [Capacity: 0.25 SP] Record closeout issue linkage readiness in `specs/183-stability-quality-bundle/**`; keep T010 as pass with linkage pending at feature closeout, bind #2446/#1627/#1761 to the bundle or final merge/squash commit at feature closeout, reference proposals without silently editing them, and include the traceability-check result before before-implement readiness is requested (Trace: TG-001, TG-002, TG-005).
