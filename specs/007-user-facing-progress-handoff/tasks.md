...
- [ ] T001 Update coordinator prompt in `extensions/specrew-speckit/prompts/coordinator-response.md` to reinforce two-field handoff contract (progress status + recommended next step) with explicit guidance for completion, blocker, and lightweight scenarios; include plain-language-first principle and examples showing governance acronyms deferred to footnotes; traceability: [FR-001][FR-003][US1][US3]
- [ ] T002 [P] Create handoff template artifact at `specs/001-specrew-product/contracts/coordinator-handoff-template.md` with three-section format (What I just did / Why I stopped / What I need from you) and patterns for completion, blocked, partial, and lightweight responses; acceptance: template is usable by agents as copy-paste starting point; traceability: [FR-001][FR-003][FR-004][US1][US3]
