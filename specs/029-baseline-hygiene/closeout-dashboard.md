...
**Captured At**: 2026-05-21T19:11:10Z
**Render Mode**: full
**Rendering Mode**: rich
...
────────────────────────────────────────────────────────────────────────
Today: 2026-05-21 | Captured: 2026-05-21T19:11:10Z
Repo: Specrew | Branch: 029-baseline-hygiene
Rendering: rich default
Summary: → F-029 Baseline Hygiene for Session-Loaded File Change Detection (Implementation Complete) | Velocity 9.55 SP/day (10 closed iterations, high)
...
WARNINGS
WARN: Feature '029-baseline-hygiene' has no active iteration artifact; showing feature-level context only.
