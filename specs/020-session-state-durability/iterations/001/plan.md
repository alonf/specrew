...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| I1-T001 | Design `sync-boundary-state.ps1` API | FR-001, FR-002, FR-003 | US2 | 1.0 | Implementer | planned | Implementer | — | — |
| I1-T002 | Implement write-temp-then-rename for single file | FR-004 | US2 | 1.5 | Implementer | planned | Implementer | — | — |
| I1-T003 | Implement multi-file sync orchestration | FR-005 | US2 | 2.0 | Implementer | planned | Implementer | — | — |
| I1-T004 | Integrate sync-boundary-state into seven boundaries | FR-003 | US2 | 2.0 | Implementer | planned | Implementer | — | — |
| I1-T005 | Test boundary-event sync atomicity | FR-001, FR-004 | US2 | 1.0 | Reviewer | planned | Implementer | — | — |
| I1-T006 | Implement merge-detection check | FR-015 | US1 | 1.5 | Implementer | planned | Implementer | — | — |
| I1-T007 | Implement branch-existence check | FR-016 | US1 | 0.5 | Implementer | planned | Implementer | — | — |
| I1-T008 | Implement authorization-record check | FR-017 | US1 | 1.0 | Implementer | planned | Implementer | — | — |
| I1-T009 | Implement cross-file consistency check | FR-018 | US1 | 1.5 | Implementer | planned | Implementer | — | — |
| I1-T010 | Implement stale-state user prompt | FR-019, FR-020 | US1 | 1.5 | Implementer | planned | Implementer | — | — |
| I1-T011 | Test stale-state detection coverage | FR-015, FR-016, FR-017, FR-018 | US1 | 1.0 | Reviewer | planned | Implementer | — | — |
| I1-T012 | Implement module-vs-project version comparison | FR-025 | US4 | 0.5 | Implementer | planned | Implementer | — | — |
| I1-T013 | Implement version mismatch warning | FR-026, FR-027, FR-028 | US4 | 0.5 | Implementer | planned | Implementer | — | — |
| I1-T014 | Test module version check in CI | FR-025, FR-026, FR-027, FR-028 | US4 | 0.5 | Reviewer | planned | Implementer | — | — |
...
- T014 captures performance baseline (`specrew start` overhead <2s) in CI as evidence for performance-baseline gate.
