...
- Next action: Recovery will re-anchor to 'C:\Dev\Specrew-cursor\specs\050-cursor-host-support' so you can repair or continue the last known feature state.

### Recovery Reasons

- Session-state feature mismatch detected: 050-cursor-host-support, 048-beta-before-stable-sdlc
...
Project root: C:\Dev\Specrew-cursor
Project root (file:// URL form for clickable references): file:///C:/Dev/Specrew-cursor
Mode: resume-feature
Active feature directory: C:\Dev\Specrew-cursor\specs\050-cursor-host-support
User feature request: (not provided yet; gather or confirm during intake)

## Welcome Back Snapshot

- Active feature: 050-cursor-host-support
- Feature path: C:\Dev\Specrew-cursor\specs\050-cursor-host-support
- Worktree: C:\Dev\Specrew-cursor
- Current boundary: (none)
- Current task: (none)
- Last completed task: (none)
- Last completed boundary: 5f2f9d18fc923feffe86c17afd7bec5d429e17b8 at 2026-05-26T18:56:51Z
