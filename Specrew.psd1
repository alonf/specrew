@{
    ...
    PrivateData = @{
        PSData = @{
            # Source prerelease state for the next intended release (v0.31.0-beta3, F-140 Unix-Native Install; also carries F-051, Spec Kit 0.9.0, Proposal 152). The
            ...
            # (v0.31.0-beta3, not v0.31.0-beta.3).
            Prerelease = 'beta3'
