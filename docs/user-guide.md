...
`specrew start --host <kind>` launches the lifecycle on the named CLI runtime instead of the Copilot default. Supported kinds: `copilot` (default), `claude`, `codex`, `antigravity`.
