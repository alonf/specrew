...
[![Version](https://img.shields.io/badge/version-0.31.0--beta1-blue.svg)](.specrew/config.yml)
...
- **Active development line**: 0.31.0-beta1 (F-140 — Unix-Native Install: native `specrew` shell wrappers + `install.sh` bootstrap so macOS/Linux users skip `pwsh`; also bundles F-051 Multi-Session Foundation, Spec Kit 0.9.0 support, and Proposal 152)
