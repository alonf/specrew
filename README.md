...
[![Version](https://img.shields.io/badge/version-0.31.1--beta1-blue.svg)](.specrew/config.yml)
...
- **Active development line**: 0.31.1-beta1 (F-160 — Unix Resolver Sidecar Hardening: resolver path-portability hardening + managed-skill marker-provenance fix, both repro-first; F-140 fast-follows via Proposals 160/161)
